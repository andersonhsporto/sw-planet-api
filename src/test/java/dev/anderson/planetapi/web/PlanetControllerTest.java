package dev.anderson.planetapi.web;
...
import static dev.anderson.planetapi.common.PlanetConstants.PLANETS;
...
import dev.anderson.planetapi.domain.PlanetService;
...
class PlanetControllerTest {
	...
	@Test
	  public void createPlanet_WithValidData_ReturnsCreated() throws Exception {
	    when(planetService.create(PLANET))
	    .thenReturn(ResponseEntity.ok(PLANET));
